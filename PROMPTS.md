...
6. PROSOPITE_TODO_UPDATE=1 bundle exec rspec を実行し、.prosopite_todo.yaml が生成されることを確認
7. 出力内容が想定通りであることを確認（YAML形式、fingerprint / query / location / created_at の存在）
8. 確認が終了したら、demo_app を削除
